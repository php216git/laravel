<?php
	...
	function sendsphone($p){
		...
		$options['accountsid']='76e8d32f9f706d3364c6f9366358a743';
		//填写在开发者控制台首页上的Auth Token
		$options['token']='b8149e9137d952647615bdefb11d2cfe';
		//初始化 $options必填
		$ucpass = new Ucpaas($options);
		$appid = "e4327e91bde4431faf5ddb0f7c2a5388";	//应用的ID，可在开发者控制台内的短信产品下查看
		$templateid = "483499";    //可在后台短信产品→选择接入的应用→短信模板-模板ID，查看该模板ID
		//发送的校验码
