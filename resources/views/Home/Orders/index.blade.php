     ...
     <ul> 
      ...
      <li class="user-addresslist" uid="{{$row->id}}"> 
       ...
       <div class="new-addr-btn"> 
        ...
        <a href="/gowu/shanchu/{{$row->id}}" onclick="delClick(this);">删除</a> 
       </div> </li>
       @endforeach
       @else
       添加收货地址
         ...
         <div class="pay-phone"> 
          ...
          <li class="td td-info"> 
           <div class="item-props"> 
            <span class="sku-line">颜色：星空蓝</span> 
       ...
       @if($addresss)
        <div class="box"> 
         ...
         <div id="holyshit268" class="pay-address"> 
          ...
          <p class="buy-footer-address"> <span class="buy-line-title">收货人：</span> <span class="buy-address-detail"> <span class="buy-user" id="user">{{$addresss->name}}</span> <span class="buy-phone" id="phone">{{$addresss->phone}}</span> </span> </p> 
         </div> 
        </div>
        @else
        请添加收货地址
